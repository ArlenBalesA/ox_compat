-- ### rsg-INPUT TO OX_LIB COMPAT ### --
if not Config.Modules['rsg-input'].active then return end
local function exportHandler(exportName, func)
    AddEventHandler(('__cfx_export_%s_%s'):format(Config.Modules['rsg-input'].resource_name, exportName), function(setCB)
        setCB(func)
    end)
end
