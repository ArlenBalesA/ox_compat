-- ### rsg-TARGET TO OX_TARGET COMPAT ### --
if not Config.Modules['rsg-target'].active then return end
local function exportHandler(exportName, func)
    AddEventHandler(('__cfx_export_%s_%s'):format(Config.Modules['rsg-target'].resource_name, exportName), function(setCB)
        setCB(func)
    end)
end
